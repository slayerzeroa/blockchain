...
function nFormatter(num, digits) {
  ...
  const digit = num > 1e5 ?  0 : digits;
  if(!item) return "0";
  if(num > 9999 || 1000 > num){
    return (num / item.value).toFixed(digit).replace(rx, "$1") + item.symbol;
  }else{
    return (num / item.value).toFixed(digit) + item.symbol;
  }
}
...
//cancelPropagation 以묒꺽�� �붿냼�먯꽌 �섏쐞�먯꽌 �곸쐞 以묒꺽�쇰줈 媛��� �대깽�� �꾪뙆瑜� 以묒�
...
//getByteLength 臾몄옄�� 諛붿씠�몃줈 蹂���
function getByteLength(s,b,i,c){
	for(b=i=0;c=s.charCodeAt(i++);b+=c>>11?3:c>>7?2:1);
	return b;
}

// getByteLength�� �쒓��� 3諛붿씠�몃줈 怨꾩궛�섏뼱�� �쒓��� 2諛붿씠�몃줈 怨꾩궛�섍린�꾪븳 ��泥댄븿��
...
/**
 * getScrollPositionBottom �ㅽ겕濡ㅼ쓽 �꾩튂媛� 留덉�留됱씤吏� 泥댄겕
 * @param content
 * @param wrap
 * @param call
 */
...
//RemoveTag �쒓렇�쒓굅 (�쒓렇 愿��⑤맂 臾몄옄瑜� �뷀떚�곗퐫�쒕줈 蹂���)
function RemoveTag(s){
	var tmp = '';
	tmp = s || ''; // 媛��� s媛� undefined �� �뚭� �덉뼱�� 怨듬갚�쇰줈 ��泥댄븷 �� �덉쑝硫� ��泥�.
	tmp += ''; // �レ옄�� 寃쎌슦 臾몄옄�대줈 留뚮뱾�댁＜湲�
	tmp = tmp.replace(/&/gi,"&amp;");
	tmp = tmp.replace(/</gi,"&lt;");
	tmp = tmp.replace(/>/gi,"&gt;");
	tmp = tmp.replace(/\"/gi,"&quot;");
...
//removeHtmlTag �쒓렇瑜� ��젣泥섎━.
function removeHtmlTag(s){
	s = s.replace(/<br\/>/ig, "\n");

	// h1~h6 �レ옄 異붽�, attribute - 異붽�
	s = s.replace(/<(\/)?([a-zA-Z1-6]*)(\s[a-zA-Z1-6-]*=[^>]*)?(\s)*(\/)?>/ig, "");
	return s;
}

//escape_javascript �먮컮�ㅽ겕由쏀듃 �댁뒪耳��댄봽 泥섎━
...
//HTML entity媛� 洹몃�濡� 異쒕젰�섎뒗 寃쎌슦 decode �묒뾽�� �� �� �덉쓬
...
/**
 * min (�ы븿) 怨� max (遺덊룷��) �ъ씠�� �꾩쓽 �뺤닔瑜� 諛섑솚
 * @param min
 * @param max
 * @returns {*}
 */
		...
		if(parameter !== ''){
			if(typeof parameter === 'object' && parameter.length > 0){
				for(var i = 1; i <= parameter.length; i++){
					str = replaceAll(str, '%' + i, parameter[i - 1]);		// 諛섍컖 �쇱꽱��
					str = replaceAll(str, '竊�' + i, parameter[i - 1]);		// �꾧컖 �쇱꽱��(�쒖옄沅� �몄뼱)
				}
			}else{
				str = replaceAll(str, '%1', parameter);		// 諛섍컖 �쇱꽱��
				str = replaceAll(str, '竊�1', parameter);		// �꾧컖 �쇱꽱��(�쒖옄沅� �몄뼱)
			}
		}
	}
...
/**
 * URL�먯꽌 �뱀젙 param留� 蹂�寃�
 * @param name
 * @param value
 * @returns {boolean}		蹂�寃� �깃났 �� true, �ㅽ뙣 �� false(history API �ъ슜 遺덇� ��)
 */
...
$.fn.imageResize = function(w, h, r, o, gh){
	...
	setTimeout(function(){
		...
		if(o == 'Y'){ //梨꾩슦湲곌� �꾨떂
			...
			if(img_ratio > fix_ratio){ // �붾㈃ 蹂대떎 �대�吏��� �믪씠媛� �щ㈃  �대�吏� �믪씠瑜� 苑됱감寃�
			...
			}else{ //�붾㈃ 蹂대떎 �대�吏� �볦씠媛� �볦쑝誘�濡� �대�吏� �덈퉬瑜� 苑됱감寃�
				//$obj.attr('doz_resize',$obj.attr('doz_resize')+'|!img_ratio>fix_ratio');
				if(w > pw){
...
$.fn.setUploadImage = function(option, callback){
	var default_option = {
					...
					if(data.originalFiles[i]['size'] > 0){
						...
						tempImg.onload = function(){
							...
							if(onload_count == data.originalFiles.length - 1){
								if(invalid_image){
									alert(getLocalizeString('�ㅻ챸_�대�吏��깅줉�ㅽ뙣', invalid_image, '%1 �대�吏� �깅줉�� �ㅽ뙣�섏��듬땲��.'));
								}else if(min_ck){
									alert(getLocalizeString('�ㅻ챸_理쒖냼�대�吏��ш린�덈궡', [_minWidth, _minHeight], '%1x%2 �댁긽�� �대�吏�留� �낅줈�� �섏떎 �� �덉뒿�덈떎.'));
								}else if(max_ck){
									alert(getLocalizeString('�ㅻ챸_理쒕��대�吏��ш린�덈궡', [_maxWidth, _maxHeight], '%1x%2 �댄븯�� �대�吏�留� �낅줈�� �섏떎 �� �덉뒿�덈떎.'));
								}else{
									data.submit();
								}
							}
						...
						tempImg.src = _url.createObjectURL(data.originalFiles[i]);		// Blob Url�� �ъ슜�섏뿬 �대�吏� �ш린 泥댄겕
					}else{
		...
		start : function(e, data){
			dozProgress.start();
			// TODO site �먯꽌�� preloader 蹂��섍� �꾩쭅 �놁쓬
			//$preloader.show();
		},
...
$.fn.setUploadFile = function(option, callback){
	var default_option = {
		...
		add: function(e, data) {
			...
			if(max_ck)
				alert(getLocalizeString('�ㅻ챸_理쒕��낅줈�쒖슜�됱븞��_寃뚯떆��', '', '理쒕� 100MB 源뚯� �낅줈�� �섏떎 �� �덉뒿�덈떎.'));
			else data.submit();
		},
		start : function(e, data){
			dozProgress.start();
...
(function(){
	 ...
	 * o.option_layer        - �ъ슜�먰솕 �덉씠��
	 * o['default']            - 湲곕낯 selected value
	...
	var setSelectBox = function(el, o){
		this.default_set = {
			select_custom_cls : '',
			custom_cls : 'design-dropdown',       // ���됲듃諛뺤뒪 媛��� �� 遺�紐⑥쓽 �대옒��
			custom_option_layer : 'N', //�듭뀡 �덉씠�� �꾩껜瑜� �ъ슜�먰솕  this.custom_layer �� jquery �� 媛앹껜瑜� 蹂대깂
			use_custom_value : 'N',                  // Y: 湲곕낯 li�� value瑜� 異붽���
			left : 0,
			use_insert : 'Y',                        // Y: �좏깮�� �� value �ｌ쓣吏� �щ�
			use_key_press : 'N',
			use_selected : 'Y',
			max_height : 260,
			item_align : 'left'
	...
	setSelectBox.prototype.setPosition = function(){
		...
		var select_offset_t = offset.top - window_scroll; //�덈��곸씤 �붾㈃�곸쓽 醫뚰몴
		var select_offset_l = offset.left; //�덈��곸씤 �붾㈃�곸쓽 醫뚰몴
		var select_container_h = that.option_container.outerHeight();
		var select_container_w = that.option_container.outerWidth();

		var obj_h = Math.round(select_offset_t + height + select_container_h); //�덈��� �붾㈃�곸쓽 醫뚰몴�먯꽌 �ㅻ젆�몃컯�ㅼ쓽 �믪씠�� �듭뀡�� �믪씠�� ��( �듭뀡�� �대졇�꾨븣 �듭뀡�� 留� �꾨옒 醫뚰몴媛�)
		var obj_w = Math.round(select_offset_l + width); //�덈��� �붾㈃�곸쓽 醫뚰몴�먯꽌 �ㅻ젆�몃컯�ㅼ쓽 �믪씠�� �듭뀡�� �믪씠�� ��( �듭뀡�� �대졇�꾨븣 �듭뀡�� 留� �꾨옒 醫뚰몴媛�)

		if(window_height < obj_h){ //�덈룄�� �ш린蹂대떎 �듭뀡 留� �꾨옒 �덈� 醫뚰몴媛� �щ떎�� 寃껋� �듭뀡�� 蹂댁씠吏� �딅뒗 寃껋씠 誘�濡� �꾨줈 蹂댁씠�꾨줉 �ㅼ젙
			if(offset.top > 350){
		...
		if(window_width < obj_w){ //�덈룄�� �ш린蹂대떎 �듭뀡 留� �꾨옒 �덈� 醫뚰몴媛� �щ떎�� 寃껋� �듭뀡�� 蹂댁씠吏� �딅뒗 寃껋씠 誘�濡� �꾨줈 蹂댁씠�꾨줉 �ㅼ젙
			if(offset.left > 350){
    ...
    let option = {};
    /**
     * option.autoHide�� 湲곕낯媛� true
     * false �쇰븣 �④꺼吏�吏� �딄퀬 蹂댁뿬吏꾨떎.
     * that�� disableAutoHide�� �됱냼�� �녾린 �뚮Ц�� ��긽 true
     */
    option['autoHide'] =
	...
	$.extend($.fn, {
		check_key : function(opt){
			...
			var default_allow_option = {
				digit: true,		// �レ옄 �덉슜 �щ�
				upper: true,		// �뚰뙆踰� ��臾몄옄 �덉슜 �щ�
				lower: true,		// �뚰뙆踰� �뚮Ц�� �덉슜 �щ�
				arrow: true,		// 諛⑺뼢�� �덉슜 �щ�
				special_list: ['Backspace', 'Tab', 'Enter', 'Esc', 'Escape', 'Home', 'End', 'Del', 'Delete'],		// 異붽� �덉슜 �뱀닔��
				allow_list: [],		 // 異붽� �덉슜 臾몄옄��(�뺢퇋�앹뿉 �ы븿�� 媛믪씠誘�濡� 二쇱쓽�� 寃�) ex) ['-', '_']
				ctrl_list: ['c', 'C', 'v', 'V']		// ctrl �⑥텞�� �덉슜 紐⑸줉
			};
		...
		check_callnum : function(){
			...
			o.off('keypress.check_callnum').on('keypress.check_callnum',function(event){
				...
				if(code && ((code > 47 && code < 58) || (event.ctrlKey == true && (code == 118 || code == 86 || code == 67)) || code == 13 || code == 8 || code == 27 || code == 45 || code == 189 || code == 43)){
					//�レ옄踰붿쐞,而⑦듃濡ㅻ툕�대��뚮Ц��,enter,back,esc,-, +
					return true;
				}else if(code && (code == 37 || code == 39 || code == 38 || code == 40)){ //諛⑺뼢��
					return true;
				}else if(code && (code == 9 || code == 46 || code == 35 || code == 36)){ //tab , del,  ��, �붾뱶
					return true;
				}else{
					event.preventDefault();
				}
			...
			o.off('keyup.check_callnum').on('keyup.check_callnum',function(event){
				var code = event.which?event.which:event.keyCode;
				if(code && (code == 37 || code == 39 || code == 38 || code == 40)) //諛⑺뼢��
					return true;
				else if(code && (code == 9 || code == 46 || code == 35 || code == 36)) //tab , del,  ��, �붾뱶
					return true;
				var str = $(this).val();
	...
	$.extend($.fn, {
		check_email : function(){
			...
			o.off('keypress.check_email').on('keypress.check_email',function(event){
				...
				if(!code)
					event.preventDefault();
				if(code > 47 && code < 58) //�レ옄踰붿쐞
					return true;
				if(code > 64 && code < 91) //�뚮Ц�먮쾾��
					return true;
				if(code > 96 && code < 123) //��臾몄옄
					return true;
				if(event.ctrlKey == true && (code == 118 || code == 86 || code == 99 || code == 67)) //而⑦듃濡쨡���뚮Ц�릀
					return true;
				if(code == 45 || code == 189) //-
					return true;
				...
				if((event.shiftKey == true && code == 189) || code == 95) //_
					return true;
				if(code == 13 || code == 8 || code == 9 || code == 27 || code == 46 || code == 35 || code == 36) //enter, back, esc, tab , del,  ��, �붾뱶
					return true;
				if(code == 37 || code == 39 || code == 38 || code == 40) //諛⑺뼢��
					return true;
...
/**
 * Froala Editor v3 �뗮똿
 * @param selector			�먮뵒�곕� �ㅼ튂�� ���됲꽣(v3 �뱀쭠�� object濡� �ㅼ젙�� �� �놁쓬)
 * @param option			events瑜� �쒖쇅�� �듭뀡(湲곗〈 events �듭뀡�� �꾨� ��뼱�뚯슱 寃쎌슦留� �닿납�� events 異붽�)
 * @param events_option		events �듭뀡(湲곗〈 events �듭뀡�� �좎��섍퀬 ��移�)
 */
var setFroala = function(selector, option, events_option){
  ...
  if(image_upload_url == "") alert(getLocalizeString('�ㅻ챸_�대�吏��낅줈�쏹RL�대퉬�댁엳�듬땲��', '', '�대�吏� �낅줈�� URL�� 鍮꾩뼱�덉뒿�덈떎.'));
  if(file_upload_url == "") alert(getLocalizeString('�ㅻ챸_�뚯씪�낅줈�쏹RL�대퉬�댁엳�듬땲��', '', '�뚯씪 �낅줈�� URL�� 鍮꾩뼱�덉뒿�덈떎.'));
  if(!isBlank(file_upload_url) && ($file_list_obj == "" || $file_list_obj.length == 0)) alert(getLocalizeString('�ㅻ챸_�뚯씪由ъ뒪�몃��뺤씤�섏꽭��', '', '�뚯씪 由ъ뒪�몃� �뺤씤�섏꽭��.'));
  ...
  //�대�吏� 援먯껜 踰꾪듉 異붽�(蹂듭닔濡� �ㅼ뼱媛�硫� �덈맖) - �� �섏씠吏��� �먮뵒�곌� �щ읉 �ъ슜�� 寃쎌슦 蹂꾧컻濡� �명똿�댁쨾�� ��
  ...
  FroalaEditor.RegisterCommand(file_insert, {
    title: getLocalizeString('踰꾪듉_�뚯씪泥⑤�_理쒕�nMB', 100, '�뚯씪泥⑤�(理쒕� %1MB)'),
    focus: false,
    undo: false,
  ...
  FroalaEditor.RegisterCommand(image_insert, {
    title: getLocalizeString('踰꾪듉_�대�吏�泥⑤�', '', '�대�吏� 泥⑤�'),
    focus: false,
    undo: false,
    refreshAfterCallback: false,
    callback: function () {
  ...
  FroalaEditor.RegisterCommand(image_replace, {
    title: getLocalizeString('踰꾪듉_�대�吏�援먯껜', '', '�대�吏� 援먯껜'),
    focus: false,
    undo: false,
    refreshAfterCallback: false,
    callback: function () {
  ...
  /***
   * �덈뱶濡쒖씠�쒖빋�먯꽌 post湲��곌린�� �대�吏� �낅줈�� �꾨즺�� 泥섎━
   * @param image
   */
  ...
  /**
   * �붿옄�몃え�쒖� �щ━ IE�먯꽌�� ComputedPropertyName(ES6 臾몃쾿)�� �ъ슜�� �� �놁쑝誘�濡� 臾몄옄�대줈 留뚮뱺 �� JSON �뚯떛
   */
  var getInlineStyle = function(){
    var inlineStyle =
      '{"' + getLocalizeString('���댄�_湲곕낯�먭컙', '', '湲곕낯 �먭컙') + '": "letter-spacing: 0;", '
      + '"' + getLocalizeString('���댄�_�먭컙', '', '�먭컙') + ' -1px": "letter-spacing: -1px;", '
      + '"' + getLocalizeString('���댄�_�먭컙', '', '�먭컙') + ' 1px": "letter-spacing: 1px;", '
      + '"' + getLocalizeString('���댄�_�먭컙', '', '�먭컙') + ' 2px": "letter-spacing: 2px;", '
      + '"' + getLocalizeString('���댄�_�먭컙', '', '�먭컙') + ' 3px": "letter-spacing: 3px;", '
      + '"' + getLocalizeString('���댄�_�먭컙', '', '�먭컙') + ' 4px": "letter-spacing: 4px;", '
      + '"' + getLocalizeString('���댄�_�먭컙', '', '�먭컙') + ' 5px": "letter-spacing: 5px;"}';
  ...
  FroalaEditor.DefineIcon('fontSize', {SRC: '//vendor.imweb.me/images/froala/font_size_white.png', template: 'image'});
  ...
  var default_option = {
    ...
    heightMin: 150,
    placeholderText: getLocalizeString('�ㅻ챸_�댁슜�꾩엯�ν빐二쇱꽭��', '', '�댁슜�� �낅젰�댁＜�몄슂'),
    ...
    tableStyles : {
      tableHorizontal: getLocalizeString('踰꾪듉_媛�濡쒓뎄遺꾩꽑留�', '', '媛�濡� 援щ텇�좊쭔'),
      noBorder: getLocalizeString('踰꾪듉_�뚮몢由ъ뾾��', '', '�뚮몢由� �놁쓬'),
      tableStrong: getLocalizeString('踰꾪듉_�뚮몢由ъ쭊�섍쾶', '', '�뚮몢由� 吏꾪븯寃�'),
      tableHover: getLocalizeString('踰꾪듉_Hover�④낵�됰떒��', '', 'Hover �④낵(�� �⑥쐞)'),
      tableHeaderDarken: getLocalizeString('踰꾪듉_�뚯씠釉뷀뿤�붿쓬��', '', '�뚯씠釉� �ㅻ뜑 �뚯쁺'),
      tableStriped: getLocalizeString('踰꾪듉_以꾨Т�ы뻾', '', '以꾨Т�� ��'),
      'm-table-style' : getLocalizeString('踰꾪듉_紐⑤컮�쇱뿉�쒗몴�뺤떇臾댁떆', '', '紐⑤컮�쇱뿉�� �� �뺤떇 臾댁떆'),
      '_table_responsive' : getLocalizeString('踰꾪듉_諛섏쓳�뺥뀒�대툝', '', '諛섏쓳�� �뚯씠釉�')
    },
    linkMultipleStyles: false,
    linkStyles: {
      'btn btn-default': getLocalizeString('踰꾪듉_湲곕낯踰꾪듉', '', '湲곕낯 踰꾪듉'),
      'btn btn-primary': getLocalizeString('踰꾪듉_媛뺤“踰꾪듉', '', '媛뺤“ 踰꾪듉')
    },
  ...
  var default_events_option = {
    ...
    'image.beforeUpload': function(images){
      if(!use_image_upload){
        alert(getLocalizeString('�ㅻ챸_�쒕옒洹몄뾽濡쒕뱶�붿��먰븯吏��딆뒿�덈떎', '', '�쒕옒洹� �낅줈�쒕뒗 吏��먰븯吏� �딆뒿�덈떎.'));
        //cancelPropagation(e);
        return false;
      }
    },
    'image.beforePasteUpload': function(img){
      if(!use_image_upload){
        alert(getLocalizeString('�ㅻ챸_�대�吏�蹂듭궗遺숈뿬�ｊ린湲곕뒫��吏��먰븯吏��딆뒿�덈떎', '', '�대�吏� 蹂듭궗 遺숈뿬�ｊ린 湲곕뒫�� 吏��먰븯吏� �딆뒿�덈떎.'));
        img.remove();
        //cancelPropagation(e);
        return false;
      }
    ...
    const that = this;
      ...
      function resizeToolbar(){
        ...
        if(!IS_MOBILE){		// PC 醫곸� �붾㈃�� ��
          pointerDownName = 'mousedown';
          pointerMoveName = 'mousemove';
          pointerUpName = 'mouseup';
        }else if(window.PointerEvent){
          // Chrome, Edge, IE11, Firefox�먯꽌�� PointerEvents �ъ슜(Safari�� TouchEvents �ъ슜�댁빞��)
          pointerDownName = 'pointerdown';
          pointerMoveName = 'pointermove';
          pointerUpName = 'pointerup';
        }
        if(is_custom_mobile){
          $('.custom-theme.fr-toolbar .fr-command.fr-btn[data-cmd="fontSize"] img').attr('src', '//vendor.imweb.me/images/froala/font_size_black.png');
          // �붿냼�� 留욊쾶 湲몄씠 議곗젅
          var tbPadding = 10;
          var tbWidth = 0;
          ...
          // �ㅽ겕濡� �섎룞 援ы쁽(Froala �먮뵒�� �대��먯꽌 �곗튂 �대깽�� 媛�濡쒖콈湲곕줈 overflow scroll�� �숈옉�섏� �딆쓬)
          ...
          // v3 �앹뾽 諛� �쒕∼�ㅼ슫 �꾩튂 �ㅼ젙 濡쒖쭅 蹂�寃쎌쑝濡� �명빐 �앹뾽 諛� �쒕∼�ㅼ슫 �꾩튂 �ㅼ젙 蹂꾨룄 �묒꽦
          ...
          $('.custom-theme.fr-toolbar .fr-command.fr-btn[data-cmd="fontSize"] img').attr('src', '//vendor.imweb.me/images/froala/font_size_white.png');
      ...
      that.toggleValue = window.localStorage.getItem('emoticon') ?? 'emoji';
      that.selector = selector
      that.theme = "black"
      that.toolbarSelector = that.$tb[0] ?? document.querySelector("#toolbarContainer")
      ...
      that.handleEmoticonBox = function () {
        ...
        that.emoticonButton = that.toolbarSelector.querySelector("[id^='emoticons-']")
        that.toggleButton = that.toolbarSelector.querySelector("select.tab-toggle") //toggle踰꾪듉 select
        that.toggleButton.value = that.toggleValue

        window.localStorage.setItem('emoticon', that.toggleValue);
        that.emoticonButton.addEventListener('click', () => { //�닿린踰꾪듉�� �꾨Ⅴ硫�
          that.activateToggle() //toggle �대깽�� �쒖꽦��
        })
      }
      ...
      that.handleToggleButton = function () {
        that.toggleButton = that.toolbarSelector.querySelector("select.tab-toggle") //toggle踰꾪듉 select
        that.toggleButton.value = that.toggleValue;
        that.toggleButton.addEventListener('change', function () { //�대깽�� �쒖꽦��
          that.toggleValue = that.toggleButton.value;
          window.localStorage.setItem('emoticon', that.toggleButton.value);
          that.opts.emoticonsUseImage = that.toggleValue == "emoji" ? false : true; //�대┃�섎㈃  �대え�곗퐯 諛⑹떇 蹂���
          that.popups.hide("emoticons") //emoticons �앹뾽 媛��ㅼ쭚
      ...
      that.deleteAndJustifyEmoticonBox = function () {
        ...
        const reopenEmoticonPopup = new Promise(function () {
          that.emoticons.showEmoticonsPopup() //�ㅼ떆 �닿린 => �� 怨쇱젙�먯꽌 媛앹껜 珥덇린�� �ㅼ떆 �꾩슂.
        })
      ...
      FroalaEditor.RegisterCommand("emoticons", {
        callback: function() {
          ...
          const that = FroalaEditor(this.selector)
          that.toggleValue = window.localStorage.getItem('emoticon') ?? 'emoji';
          that.opts.emoticonsUseImage = that.toggleValue == 'froala' ? true : false; //�대┃�섎㈃  �대え�곗퐯 諛⑹떇 蹂���
    ...
    'paste.before': function(original_event){
      //ios湲곌린�� �ㅽ겕濡ㅼ빻�뚯씠�덈� 李얠�紐삵븯�� �먮뵒�� 踰꾧렇�뚮Ц�� �좎��먯씠�꾪듃瑜� �쇱떆�곸쑝濡� 蹂�議고븿
      // TODO v3�먯꽌 �대떦 踰꾧렇 �⑥븘�덈뒗吏� �뺤씤�섍퀬 �섏젙�섏뿀�쇰㈃ �쒓굅�� 寃�
  ...
  var extend_events_option = $.extend(default_events_option, events_option);		// 湲곕낯 events �듭뀡�� 而ㅼ뒪�� events �듭뀡 ��移�
  default_option = $.extend(default_option, {'events': extend_events_option});		// 湲곕낯 �듭뀡�� events �듭뀡 異붽�
  var extend_option = $.extend(default_option, option);		// 湲곕낯 �듭뀡�� 而ㅼ뒪�� �듭뀡 異붽�(而ㅼ뒪�� events_option�� �꾨땶 而ㅼ뒪�� option�� events �듭뀡�� �ы븿�� 寃쎌슦 湲곗〈 events_option�� 臾댁떆�섍퀬 ��泥�)
  extend_option = $.extend(extend_option, {'file_list_obj':''});
  if(extend_option.mobile_custom && extend_option.toolbarButtonsMobile){
    // toolbarButtonsXS�� 蹂꾧컻濡� 紐⑤컮�쇱뿉�쒕쭔 蹂댁씠�� 踰꾪듉 �ㅼ젙
    extend_option = $.extend(extend_option, {
      toolbarButtonsXS : extend_option.toolbarButtonsMobile
    });
  }
  var lang_code = 'ko';		// froala editor�� �몄뼱 肄붾뱶
  ...
  var unit_lang_code = $('#toolbarContainer').attr('data-lang');		// �ㅺ뎅�� �ъ씠�� �몄뼱 肄붾뱶
...
//setFroala3 - Froala Editor v3 �뚯뒪��
//���됲꽣�� �듭뀡�� �몄옄濡� 諛쏅뒗 �⑥닔濡� 蹂�寃쏀븿
(function($){
  var android_que = [];
  var post_image_que = [];
...
$(function(){
	...
	$.cocoaDialog = {
		...
		open : function(o, callback){
			...
			// width�� 怨쇨굅 �ъ슜�섏� �딅뒗 �듭뀡媛믪쑝濡� deprecated 泥섎━, ���� pc_width �ъ슜
        ...
        this.obj.find('.modal-dialog').css('width', o.pc_width);
			...
			if(o.close_block){
				...
				// if(navigator.userAgent.match(/Trident\/7\./) || navigator.userAgent.indexOf("msie") != -1) //ie�먯꽌留� 紐⑤떖�� ��씤�깆뒪 �곸슜
				// 	this.obj.attr('tabindex','-1');//esc濡� 紐⑤떖 �リ린
			...
			/* 紐⑤떖 �ㅽ겕濡ㅼ씠 �앷린�� 寃쎌슦 body �ㅽ겕濡ㅼ씠 �꾨땲湲� �뚮Ц�� 紐⑤떖 �ㅼ쓽 �댁슜�� �ㅽ겕濡� �꾨옒濡� �ㅼ뼱媛��� 臾몄젣媛� �덉뼱 padding�쇰줈 蹂댁젙 */
			...
			if ($tooltip) {
				// �リ린 �꾩씠肄섏씠 �덈뒗吏� �뺤씤 & bootstrap �댄똻 �띿꽦異붽�
				$tooltip.has('.btl.bt-times')
					.attr('data-toggle', 'tooltip')
					.attr('data-placement', 'bottom')
					.attr('data-original-title', getLocalizeString('踰꾪듉_�リ린', '', '�リ린'));
				// �댄똻 �쒖꽦��
				$tooltip.tooltip();
			}
				...
				if ( $submit_btn.length > 0 ) {
					if ( this.isContainFormElements() ) {
						if ( this.use_enter ) {
							...
							// �� �낅젰 諛� �좏깮 �붿냼媛� 議댁옱�� 寃쎌슦 �명뭼�� �ъ빱�� 媛��덈뒗 �곹깭�먯꽌留� �곸슜
							if ( $(event.target).prop('tagName').toLowerCase() === 'input' ) {
								//$submit_btn.trigger('click');
							}
						}
					} else {
						// 洹몃깷 �뺤씤 �쇰읉媛쒕뀗�� 紐⑤떖�� 寃쎌슦
						$submit_btn.trigger('click');
					}
				}
			}
		...
		delete_popup : '<div class="modal-header">' + getLocalizeString('�ㅻ챸_��젣�섏떆寃좎뒿�덇퉴', '', '��젣�섏떆寃좎뒿�덇퉴?') + '</div><div class="btn-group btn-group-justified" role="group" aria-label="Justified button group"> <a href="javascript:;" id="dialog_popup_cancel"class="bt bt-default" role="button">' + getLocalizeString('�ㅻ챸_痍⑥냼', '','痍⑥냼') + '</a> <a href="javascript:;" id="dialog_popup_delete" class="bt bt-default" role="button">' + getLocalizeString('�ㅻ챸_�뺤씤', '', '�뺤씤') + '</a> </div>',
		...
		page_add_popup : '<div class="input-group"> <input type="text" class="menu_name _name" placeholder="' + getLocalizeString('�ㅻ챸_硫붾돱紐낆엯��', '', '硫붾돱紐� �낅젰') + '"> <span class="input-group-btn"> <button class="bt bt-default _btn" type="button">' + getLocalizeString('�ㅻ챸_�뺤씤', '', '�뺤씤') + '</button> </span> </div>',
		...
		save_popup : '<div class="modal-header">' + getLocalizeString('�ㅻ챸_���ν븯�쒓쿋�듬땲源�', '', '���� �섏떆寃좎뒿�덇퉴?') + '</div><div class="modal-footer"><button class="bt bt-default" id="dialog_popup_cancel">' + getLocalizeString('�ㅻ챸_痍⑥냼', '', '痍⑥냼') + '</button><button class="bt bt-primary" id="dialog_popup_save">' + getLocalizeString('�ㅻ챸_����', '', '����') + '</button></div></div>',
		...
		alert_popup : '<div class="modal-header design_alert_header">' + getLocalizeString('�ㅻ챸_�꾨즺�섏뿀�듬땲��', '', '�꾨즺�섏뿀�듬땲��') + '</div><div class="modal-footer design_alert_popup"><button id="dialog_popup_alert" class="bt bt-flat bt-primary" type="button">' + getLocalizeString('�ㅻ챸_�뺤씤', '', '�뺤씤') + '</button></div>',
		...
		alert_btn_popup : '<div class="modal-header"><button type="button" class="close _modal_close" data-dismiss="modal" aria-label="Close"><i class="btl bt-times" style="padding:4px"></i></button><h4 class="modal-title _modal_title text-center font-kakao"></h4></div>'
			...
			+ '<div class="modal-footer no-padding"> <div class="btn-group-justified"><a href="javascript:;" class="btn _cancel cancel"  data-dismiss="modal">' + getLocalizeString('�ㅻ챸_痍⑥냼', '', '痍⑥냼') + '</a><a href="javascript:;" class="btn btn-primary _confirm confirm" id="dialog_popup_alert_btn">' + getLocalizeString('�ㅻ챸_�뺤씤', '', '�뺤씤') + '</a></div></div>',
		...
		alert_responsive_popup : '<div class="modal-body _modal_body text-14"></div>'
			+ '<div class="modal-footer no-padding"> <a href="javascript:;" class="btn _cancel cancel"  data-dismiss="modal">' + getLocalizeString('�ㅻ챸_痍⑥냼', '', '痍⑥냼') + '</a><a href="javascript:;" class="btn _confirm confirm" id="dialog_popup_alert_btn">' + getLocalizeString('�ㅻ챸_�뺤씤', '', '�뺤씤') + '</a></div>',
		...
		alert_designmode_popup : '<div class="modal-body _modal_body text-14"></div>'
			+ '<div class="modal-footer _modal_footer no-padding"><div class="btn-wrap"><a href="javascript:;" class="btn _cancel cancel"  data-dismiss="modal">' + getLocalizeString('�ㅻ챸_痍⑥냼', '', '痍⑥냼') + '</a><a href="javascript:;" class="btn _confirm confirm" id="dialog_popup_alert_btn">' + getLocalizeString('�ㅻ챸_�뺤씤', '', '�뺤씤') + '</a></div></div>',
...
/**
 * 踰꾪듉 �대┃ �� �대떦 �꾩튂�먯꽌 異쒕젰�섎뒗 紐⑤떖
 * (�꾩옱 ���쒕낫�쒕쭔 css ���묐릺�댁엳��, �ㅻⅨ 怨녹뿉�� �ъ슜 �� css ���묓븷 寃�)
 */
$(function(){
	$.cocoaStickerModal = {
		default_option: {
			id: 'cocoaStickerModal',
			target: document.body,		// fixed�� target �꾨옒�� 異쒕젰��, fixed �섏� �딆� ���곸뿉 �ъ슜�섎젮硫� 異붽� 援ы쁽�� 寃�
			html: '',
			width: '320px',		// px �몄뿉 �ㅻⅨ �⑥쐞�� �ъ슜�� �� �덉뼱 string 洹몃�濡� 諛쏆쓬
			top: 0,		// 異붽� Y異� 蹂댁젙 �꾩튂, px(�⑥쐞 �쒖쇅)
			left: 0,		// 異붽� X異� 蹂댁젙 �꾩튂, px(�⑥쐞 �쒖쇅)
			mobile_full: true		// 紐⑤컮�쇱뿉�� �꾩껜�붾㈃�쇰줈 �쒖떆
		},
		open: function(o, callback){
			var that = this;
 ...
 * �띿쉘 異붽��섎㈃�� 湲곕뒫�곸쑝濡쒕뒗 �숈씪�섎�濡� 媛숈씠�곕룄濡� 蹂�寃� ��
...
var IMWEB_STORAGE = function(_type){
	...
	/**
	 * @param key
	 * @param expire_callback �ㅺ� 留뚮즺�섏뿀�� �� �몄텧�� 肄쒕갚�⑥닔
	 * @param expire 留뚮즺�쒓컙 ( second �⑥쐞 )
	 * @returns {null|*}
	 */
...
/**
 * �좊떅 �ㅺ뎅�� 肄붾뱶瑜� moment, datetimepicker �깆뿉�� �ъ슜�섎뒗 肄붾뱶濡� 蹂���
	...
	return function(key, callback) {
		return {
			throttling: function(timeout) {
				// �ㅻ줈��留� - 留덉�留� �⑥닔媛� �몄텧�� �� �쇱젙 �쒓컙�� 吏��섍린 �꾩뿉 �ㅼ떆 �몄텧�섏� �딅룄濡� �섎뒗 寃�
				if ( ! handle_list[key] ) {
			...
			debouncing: function(timeout) {
				// �붾컮�댁떛 - �곗씠�� �몄텧�섎뒗 �⑥닔�� 以� 留덉�留� �⑥닔(�먮뒗 �쒖씪 泥섏쓬)留� �몄텧�섎룄濡� �섎뒗 寃�
...
function getWesternAge(birthday) {
	// Date 媛앹껜�� birthday 瑜� 留ㅺ컻蹂��섎줈 諛쏅뒗 getWesternAge �⑥닔 �앹꽦
	var rightNow = new Date();
	var age = rightNow.getFullYear() - birthday.getFullYear();
	// �꾩옱 �곕룄�먯꽌 �앹씪 �곕룄瑜� 類� 媛믪쓣 age refresh_connection_queue.cm濡� �쒕떎.
	...
	// �꾩옱 �좎쭨�� �앹씪 �좎쭨瑜� 蹂��섏뿉 ���ν븳��.

	// �꾨옒 肄붾뱶�� �ㅼ쓬 �먮쫫�� �곕씪 �묒꽦�섏뿀��.
	// 1. �앹씪 �붽낵 �꾩옱 �붿쓣 鍮꾧탳 (3媛�吏� 寃쎌슦�� �섎� if, else if, else 濡� 泥섎━)
	// 2. �앹씪 �붽낵 �꾩옱 �붿씠 媛숈쓣 寃쎌슦, �좎쭨瑜� 鍮꾧탳
