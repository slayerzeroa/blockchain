if (typeof web3 !== 'undefined') { web3 = new Web3(web3.currentProvider); } else {web3 = new Web3(new Web3.providers.HttpProvider("https://sepolia.infura.io/v3/9041415e6a4c43d9a9475c8d19a57d0b")); }
